...
import { IsEmail, IsString, IsBoolean, IsOptional, Length, IsUUID, IsPhoneNumber } from 'class-validator';
import { Exclude, Transform } from 'class-transformer';
import { ApiProperty, ApiPropertyOptional } from '@nestjs/swagger';

/**
 * Patient entity representing a client in the coaching platform.
 * Enterprise-grade entity with PHI compliance, validation, and security features.
 * Note: This is for coaching clients, not medical patients.
 */
@Entity('patients')
