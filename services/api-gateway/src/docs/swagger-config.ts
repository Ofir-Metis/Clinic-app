...
export class SwaggerConfig {
  ...
  static createOptions(): SwaggerDocumentOptions {
    return {
...
export class SwaggerSchemas {
  static readonly StandardResponse = {
    type: 'object',
    properties: {
  ...
  static readonly HealthResponse = {
    type: 'object',
    properties: {
  ...
  static readonly PaginationResponse = {
    type: 'object',
    properties: {
 ...
 */
export class HealthcareExamples {
  static readonly PatientExample = {
    id: 'pat_123456789',
    firstName: 'John',
    lastName: 'Doe',
