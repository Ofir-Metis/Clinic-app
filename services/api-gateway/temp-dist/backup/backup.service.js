...
let BackupService = (() => {
    ...
    var BackupService = _classThis = class {
         ...
         * Create a new backup
         */
        async createBackup(request, adminUserId) {
            try {
        ...
        async simulateBackupCompletion(backupId) {
         ...
         * Delete a backup
         */
        async deleteBackup(backupId, adminUserId) {
            try {
         ...
         * Restore from backup
         */
        async restoreBackup(request, adminUserId) {
            try {
                ...
                if (request.confirmationCode !== 'CONFIRM_RESTORE') {
                    throw new common_1.HttpException('Invalid confirmation code', common_1.HttpStatus.BAD_REQUEST);
                }
                const restore = {
                    id: restoreId,
         ...
         */
        async createBackupSchedule(request, adminUserId) {
            try {
         ...
         */
        async updateBackupSchedule(scheduleId, request, adminUserId) {
            try {
         ...
         */
        async deleteBackupSchedule(scheduleId, adminUserId) {
            try {
         ...
         */
        async createDisasterRecoveryPlan(plan, adminUserId) {
            try {
         ...
         */
        async testDisasterRecoveryPlan(planId, testOptions, adminUserId) {
            try {
         ...
         * Cleanup old backups
         */
        async cleanupOldBackups(options, adminUserId) {
            try {
