...
const program_templates_service_1 = require("./program-templates.service");
...
let ProgramsModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            ...
            providers: [program_templates_service_1.ProgramTemplatesService],
            controllers: [programs_controller_1.ProgramsController],
            exports: [program_templates_service_1.ProgramTemplatesService],
        })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var ProgramsModule = _classThis = class {
    };
